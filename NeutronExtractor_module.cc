            ...
            for (auto particle : *mcParticles)
            {
                ...
                if (particle.PdgCode() == 11)
                {
                    ...
                    )
                    {
                        ...
                        std::cout << "Electron: " << particle.TrackId() << "," << particle.Mother() << "(" << particle.T() << "," << particle.Vx() << "," << particle.Vy() << "," << particle.Vz() << ")" << " (" << particle.EndT() << "," << particle.EndX() << "," << particle.EndY() << "," << particle.EndZ() << ")";
                    }
                }
            }
        }
